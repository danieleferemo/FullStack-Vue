const InputForm = { 
  template: `
    <div class="input-form">
      <form @submit="submitForm" class="ui form">
        ...
        <div class="field">
          <label>Urgency</label>
          <select class="ui fluid search dropdown" :value="urgency" @input="onInputChange" name="URGENCY">
        ...
        <button class="ui button" v-if="saveStatus === 'SAVING'" disabled>Saving...</button>
      ...
      <div class="ui segment">
        ...
        <ul>
          ...
          <li class="item" v-for="x in items">{{ x }}</li>
        </ul>
      </div>
    </div>`,
  data () {
  ...
  methods: {
    ...
    validateForm (fields) {
      ...
      if (!this.$store.state.fields.newItem) errors.newItem = "New Item Required";
      if (!this.$store.state.fields.email) errors.email = "Email Required";
      if (!this.$store.state.fields.urgency) errors.urgency = "Urgency Required";
      if (!this.$store.state.fields.termsAndConditions) errors.termsAndConditions = "Terms and Conditions have to be approved";

      if (this.$store.state.fields.email && !this.isEmail(this.$store.state.fields.email)) errors.email = "Invalid Email";
